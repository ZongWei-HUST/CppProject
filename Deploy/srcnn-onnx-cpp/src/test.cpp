...
int main(int argc, char* argv[]) {
  ...
  Ort::Session session(env, "../models/srcnn.onnx", session_options);
  ...
  cv::Mat img = cv::imread("../assets/face.png", cv::IMREAD_UNCHANGED);
  //   show_shape(img);
  ...
  cv::imwrite("../assets/face_result_cpp.png", result);
  //   // // cv::waitKey(0);
